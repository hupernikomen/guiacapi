...
exports.rotas = rotas;
rotas.post('/usuario', authenticator_1.Authenticator, new CriaUsuarioController_1.CriaUsuarioController().handle);
rotas.put('/usuario', authenticator_1.Authenticator, new AtualizaUsuarioController_1.AtualizaUsuarioController().handle);
rotas.get('/usuarios', authenticator_1.Authenticator, new ListarUsuariosController_1.ListarUsuariosController().handle);
...
rotas.post('/categoria', authenticator_1.Authenticator, new CriaCategoriaController_1.CriaCategoriaController().handle);
rotas.delete('/categoria', authenticator_1.Authenticator, new DeletaCategoriaController_1.DeletaCategoriaController().handle);
rotas.put('/categoria', authenticator_1.Authenticator, new AtualizaCategoriaController_1.AtualizaCategoriaController().handle);
rotas.post('/subcategoria', authenticator_1.Authenticator, new CriaSubCategoriaController_1.CriaSubCategoriaController().handle);
...
rotas.post('/regiao', authenticator_1.Authenticator, new CriaRegiaoController_1.CriaRegiaoController().handle);
...
rotas.post('/campanha', authenticator_1.Authenticator, new CriaCampanhaController_1.CriaCampanhaController().handle);
rotas.put('/campanha', authenticator_1.Authenticator, new AtualizaCampanhaController_1.AtualizaCampanhaController().handle);
...
rotas.post('/mapa', authenticator_1.Authenticator, new CriaMapaController_1.CriaMapaController().handle);
rotas.get('/mapa', new BuscaMapaController_1.BuscaMapaController().handle);
rotas.put('/mapa', authenticator_1.Authenticator, new AtualizaMapaController_1.AtualizaMapaController().handle);
...
rotas.delete('/contato', authenticator_1.Authenticator, new DeletaContatoController_1.DeletarContatoController().handle);
...
rotas.post('/loja', authenticator_1.Authenticator, new CriaLojaController_1.CriaLojaController().handle);
...
rotas.post('/profissional', authenticator_1.Authenticator, new CriaProfissionalController_1.CriaProfissionalController().handle);
...
rotas.put('/profissao', authenticator_1.Authenticator, new AtualizaProfissaoController_1.AtualizaProfissaoController().handle);
