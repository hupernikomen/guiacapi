...
const BuscaPostoController_1 = require("./controllers/gasStation/BuscaPostoController");
...
const AtualizaPostoController_1 = require("./controllers/gasStation/AtualizaPostoController");
...
const CriaPostoController_1 = require("./controllers/gasStation/CriaPostoController");
...
const ListaPostosController_1 = require("./controllers/gasStation/ListaPostosController");
...
rotas.post('/profession', new CriaProfissaoController_1.CriaProfissaoController().handle);
