...
const ListaSubCategoriasService_1 = require("../../services/subcategoria/ListaSubCategoriasService");
class ListaSubCategoriaController {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const subcategorias = yield listaSubCategoriasService.execute({ categoriaID });
