...
exports.CriarSubCategoriaService = void 0;
...
class CriarSubCategoriaService {
    execute({ nome, categoriaID }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const subcategoria = yield prisma_1.default.subCategoria.create({
                data: {
                    nome,
                    categoriaID
                }
...
exports.CriarSubCategoriaService = CriarSubCategoriaService;
